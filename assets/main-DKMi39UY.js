...
`);return t==="flow"?Wr(n):t==="bars"?Xr(n):`<pre><code>${_r(n,t)}</code></pre>`}function ai(e,t){const n=[];for(const a of e)t.test(a)?n.push(a.replace(t,"")):n.length&&(n[n.length-1]+=`
