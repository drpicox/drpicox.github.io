...
`);return t==="flow"?Hr(n):t==="bars"?Zr(n):`<pre><code>${qr(n,t)}</code></pre>`}function si(e,t){const n=[];for(const a of e)t.test(a)?n.push(a.replace(t,"")):n.length&&(n[n.length-1]+=`
...
`}],Pn="---";function Fi(e){return(/^"(.*)"$/.exec(e)??/^'(.*)'$/.exec(e))?.[1]??e}function Bi(e){const t=e.replace(/\r\n?/g,`
`).split(`
