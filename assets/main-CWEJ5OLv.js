...
was grown
as this page opened.`,href:"/worlds/"}];let dt=null;const Vs={name:"headline",arrive:e=>{if(dt?.(),dt=null,e.route!=="/")return;let t=null;dt=Ys((n,a)=>(t??=Us([a,...Js],Math.random),t(n)))}};function Nn(e,t="You"){const n=new Function("fish","weeks","bots","me","rounds",e);return{name:t,orders:n}}const Dn=`// Return your orders for the round: one number a week, 0 to rest.
